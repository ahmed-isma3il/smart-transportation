...
class AccountInfoPage extends StatelessWidget {
  ...
  children: [
    Image.asset(AssetsManager.upload, height: 20.h, width: 18.w),
    SizedBox(width: 6),
    GestureDetector(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          fontWeight: FontWeight.w700,
              ...
              // --- Phone Number ---
              buildField(title: "Phone Number:", value: "+20 99999999",context: context),

              const SizedBox(height: 16),

              // --- Email ---
              buildField(title: "E-mail:", value: "aaaaa@gmail.com",context: context),

              const SizedBox(height: 16),

              // --- Password ---
              buildField(title: "Password:", value: "********",context: context),
            ],
          ),
        ),
      ),
